...
app_1.firestore.Query.prototype.observeDocsData = function (options) {
...
app_1.firestore.Query.prototype.observeDocs = function (options) {
    return this.observeSnapshot(options).pipe(operators_1.map(function (snapshot) {
        return snapshot.docs;
    }));
};
app_1.firestore.Query.prototype.observeSnapshot = function (options) {
    var _this = this;
