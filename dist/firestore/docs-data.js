            ...
            switch (_b.label) {
                ...
                case 4:
                    if (options && options.serializer) {
                        return [2 /*return*/, this.unserialize(data, new json_1.ArraySerializer(options.serializer), options.serializationOptions)];
                    }
...
firestore_1.UniversalFirestore.prototype.docsData = docsData;
