...
export declare function applyConverter<T>(documentRef: DocumentReference<any>, converter: FirestoreDataConverter<T>): typeof documentRef extends firestoreClientTypes.DocumentReference ? firestoreClientTypes.DocumentReference : firestoreAdminTypes.DocumentReference<T>;
...
export declare function applyConverter<T>(collectionRef: CollectionReference<any>, converter: FirestoreDataConverter<T>): typeof collectionRef extends firestoreClientTypes.CollectionReference ? firestoreClientTypes.CollectionReference<T> : firestoreAdminTypes.CollectionReference<T>;
...
export declare function applyConverter<T>(query: Query, converter: FirestoreDataConverter<T>): typeof query extends firestoreClientTypes.Query<T> ? firestoreClientTypes.Query<T> : firestoreAdminTypes.Query<T>;
