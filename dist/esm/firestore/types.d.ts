...
export interface GeoPointStatic {
    /**
...
export interface TimestampStatic {
     ...
     */
    new (seconds: number, nanoseconds: number): any;
}
/**
...
export interface DocumentReference {
    ...
    onSnapshot(onNext: (snapshot: DocumentSnapshot) => void, onError?: (error: Error) => void, onCompletion?: () => void): () => void;
    onSnapshot(options: SnapshotListenOptions, onNext: (snapshot: DocumentSnapshot) => void, onError?: (error: Error) => void, onCompletion?: () => void): () => void;
}
/**
 ...
 */
export declare type WhereFilterOp = '<' | '<=' | '==' | '>=' | '>' | 'array-contains' | 'array-contains-any' | 'in';
/**
...
export interface FieldValueStatic {
    /**
...
export interface FieldPathStatic {
    /**
     ...
     */
    new (...fieldNames: string[]): FieldPath;
    /**
