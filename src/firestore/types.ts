// https://github.com/firebase/firebase-js-sdk/blob/28bb3add8f7b8210a6d388e24e8206a92e32efb0/packages/firestore-types/index.d.ts
...
export interface TimestampStatic {
     ...
     */
    new(seconds: number, nanoseconds: number);
